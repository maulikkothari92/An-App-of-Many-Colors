...
function prepareCanvas()
{
    ...
    $('#canvas').mousedown(function(e)
    {
        ...
        paint = true;
        addClick(mouseX, mouseY, false, curColor, curTool, curSize);
        emitClick(mouseX, mouseY, false, curColor, curTool, curSize);
    ...
    $('#canvas').mousemove(function(e){
        if(paint==true){
            addClick(e.pageX - this.offsetLeft, e.pageY - this.offsetTop, true, curColor, curTool, curSize);
            emitClick(e.pageX - this.offsetLeft, e.pageY - this.offsetTop, true, curColor, curTool, curSize);
            redraw();
        }
    });
...
* @param dragging
*/
function addClick(x, y, dragging, curColor, curTool, curSize)
{
    clickX.push(x);
    clickY.push(y);
...
function emitClick(x, y, dragging, curColor, curTool, curSize)
{
    // Each Socket.IO connection has a unique session id
      ...
      io.emit( 'addClick', data, sessionId )
